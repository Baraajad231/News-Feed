...
function App() {
  ...
  const loadData = async (q, page) => {
    ...
    const response = await fetch(
      `https://newsapi.org/v2/top-headlines?country=us&q=${q}&page=${page}&pageSize=5&apiKey=${import.meta.env.VITE_NEWS_API_KEY}21`,
    );
  ...
  return (
    <Container>
      ...
      {error.length === 0 ?       <NewsFeed articles={articles} loading={isLoading} />
 : }
      <Footer>
        <Button
          variant="outlined"
