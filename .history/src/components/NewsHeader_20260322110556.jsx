...
const NewsHeader = ({ onSearchChange, onCategoryChange }) => {
  const handleShearchChange = (e) => {
    onSearchChange(e.target.value);
  };

  const handleSlectCategory = (e) => {
    onCategoryChange(e.target.dataset.value);
  };
  ...
  return (
    <AppBar position="static">
      <Toolbar>
        ...
        <StyledSelect onClick={handleSlectCategory} defaultValue={"general"}>
          <StyledMenuItem value="general" selected>
            General
          </StyledMenuItem>
