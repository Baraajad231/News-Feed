...
function App() {
  ...
  const loadData = async (q, page, category = "general") => {
    // const controller = new AbortController();

    const response = await fetch(
      `https://newsapi.org/v2/top-headlines?country=us&q=${q}&page=${page}&pageSize=10&category=${category}&apiKey=${import.meta.env.VITE_NEWS_API_KEY}`,
    );
